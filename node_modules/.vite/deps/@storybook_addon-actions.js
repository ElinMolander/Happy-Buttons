...
function wordsToMd5(x2, len) {
  ...
  for (let i = 0; i < x2.length; i += 16) {
    ...
    const oldc = c2;
    const oldd = d;
    a = md5ff(a, b2, c2, d, x2[i], 7, -680876936);
    d = md5ff(d, a, b2, c2, x2[i + 1], 12, -389564586);
    c2 = md5ff(c2, d, a, b2, x2[i + 2], 17, 606105819);
    b2 = md5ff(b2, c2, d, a, x2[i + 3], 22, -1044525330);
    a = md5ff(a, b2, c2, d, x2[i + 4], 7, -176418897);
    d = md5ff(d, a, b2, c2, x2[i + 5], 12, 1200080426);
    c2 = md5ff(c2, d, a, b2, x2[i + 6], 17, -1473231341);
    b2 = md5ff(b2, c2, d, a, x2[i + 7], 22, -45705983);
    a = md5ff(a, b2, c2, d, x2[i + 8], 7, 1770035416);
    d = md5ff(d, a, b2, c2, x2[i + 9], 12, -1958414417);
    c2 = md5ff(c2, d, a, b2, x2[i + 10], 17, -42063);
    b2 = md5ff(b2, c2, d, a, x2[i + 11], 22, -1990404162);
    a = md5ff(a, b2, c2, d, x2[i + 12], 7, 1804603682);
    d = md5ff(d, a, b2, c2, x2[i + 13], 12, -40341101);
    c2 = md5ff(c2, d, a, b2, x2[i + 14], 17, -1502002290);
    b2 = md5ff(b2, c2, d, a, x2[i + 15], 22, 1236535329);
    a = md5gg(a, b2, c2, d, x2[i + 1], 5, -165796510);
    d = md5gg(d, a, b2, c2, x2[i + 6], 9, -1069501632);
    c2 = md5gg(c2, d, a, b2, x2[i + 11], 14, 643717713);
    b2 = md5gg(b2, c2, d, a, x2[i], 20, -373897302);
    a = md5gg(a, b2, c2, d, x2[i + 5], 5, -701558691);
    d = md5gg(d, a, b2, c2, x2[i + 10], 9, 38016083);
    c2 = md5gg(c2, d, a, b2, x2[i + 15], 14, -660478335);
    b2 = md5gg(b2, c2, d, a, x2[i + 4], 20, -405537848);
    a = md5gg(a, b2, c2, d, x2[i + 9], 5, 568446438);
    d = md5gg(d, a, b2, c2, x2[i + 14], 9, -1019803690);
    c2 = md5gg(c2, d, a, b2, x2[i + 3], 14, -187363961);
    b2 = md5gg(b2, c2, d, a, x2[i + 8], 20, 1163531501);
    a = md5gg(a, b2, c2, d, x2[i + 13], 5, -1444681467);
    d = md5gg(d, a, b2, c2, x2[i + 2], 9, -51403784);
    c2 = md5gg(c2, d, a, b2, x2[i + 7], 14, 1735328473);
    b2 = md5gg(b2, c2, d, a, x2[i + 12], 20, -1926607734);
    a = md5hh(a, b2, c2, d, x2[i + 5], 4, -378558);
    d = md5hh(d, a, b2, c2, x2[i + 8], 11, -2022574463);
    c2 = md5hh(c2, d, a, b2, x2[i + 11], 16, 1839030562);
    b2 = md5hh(b2, c2, d, a, x2[i + 14], 23, -35309556);
    a = md5hh(a, b2, c2, d, x2[i + 1], 4, -1530992060);
    d = md5hh(d, a, b2, c2, x2[i + 4], 11, 1272893353);
    c2 = md5hh(c2, d, a, b2, x2[i + 7], 16, -155497632);
    b2 = md5hh(b2, c2, d, a, x2[i + 10], 23, -1094730640);
    a = md5hh(a, b2, c2, d, x2[i + 13], 4, 681279174);
    d = md5hh(d, a, b2, c2, x2[i], 11, -358537222);
    c2 = md5hh(c2, d, a, b2, x2[i + 3], 16, -722521979);
    b2 = md5hh(b2, c2, d, a, x2[i + 6], 23, 76029189);
    a = md5hh(a, b2, c2, d, x2[i + 9], 4, -640364487);
    d = md5hh(d, a, b2, c2, x2[i + 12], 11, -421815835);
    c2 = md5hh(c2, d, a, b2, x2[i + 15], 16, 530742520);
    b2 = md5hh(b2, c2, d, a, x2[i + 2], 23, -995338651);
    a = md5ii(a, b2, c2, d, x2[i], 6, -198630844);
    d = md5ii(d, a, b2, c2, x2[i + 7], 10, 1126891415);
    c2 = md5ii(c2, d, a, b2, x2[i + 14], 15, -1416354905);
    b2 = md5ii(b2, c2, d, a, x2[i + 5], 21, -57434055);
    a = md5ii(a, b2, c2, d, x2[i + 12], 6, 1700485571);
    d = md5ii(d, a, b2, c2, x2[i + 3], 10, -1894986606);
    c2 = md5ii(c2, d, a, b2, x2[i + 10], 15, -1051523);
    b2 = md5ii(b2, c2, d, a, x2[i + 1], 21, -2054922799);
    a = md5ii(a, b2, c2, d, x2[i + 8], 6, 1873313359);
    d = md5ii(d, a, b2, c2, x2[i + 15], 10, -30611744);
    c2 = md5ii(c2, d, a, b2, x2[i + 6], 15, -1560198380);
    b2 = md5ii(b2, c2, d, a, x2[i + 13], 21, 1309151649);
    a = md5ii(a, b2, c2, d, x2[i + 4], 6, -145523070);
    d = md5ii(d, a, b2, c2, x2[i + 11], 10, -1120210379);
    c2 = md5ii(c2, d, a, b2, x2[i + 2], 15, 718787259);
    b2 = md5ii(b2, c2, d, a, x2[i + 9], 21, -343485551);
    a = safeAdd(a, olda);
    b2 = safeAdd(b2, oldb);
    c2 = safeAdd(c2, oldc);
    d = safeAdd(d, oldd);
...
function md5ff(a, b2, c2, d, x2, s, t) {
  return md5cmn(b2 & c2 | ~b2 & d, a, b2, x2, s, t);
}
function md5gg(a, b2, c2, d, x2, s, t) {
  return md5cmn(b2 & d | c2 & ~d, a, b2, x2, s, t);
}
function md5hh(a, b2, c2, d, x2, s, t) {
  return md5cmn(b2 ^ c2 ^ d, a, b2, x2, s, t);
}
function md5ii(a, b2, c2, d, x2, s, t) {
  return md5cmn(c2 ^ (b2 | ~d), a, b2, x2, s, t);
}
var md5_default = md5;
...
function sha1(bytes) {
  ...
  for (let i = 0; i < N2; ++i) {
    ...
    for (let t = 0; t < 80; ++t) {
      ...
      const T = ROTL(a, 5) + f2(s, b2, c2, d) + e + K[s] + W[t] >>> 0;
      e = d;
      d = c2;
      c2 = ROTL(b2, 30) >>> 0;
      b2 = a;
...
// node_modules/@storybook/channels/dist/chunk-3LQB65TK.mjs
var import_qs = __toESM(require_lib(), 1);
var { document: document2, location } = scope;

// node_modules/@storybook/channels/dist/chunk-V4SVTEPD.mjs
var { WebSocket } = scope;
...
// node_modules/@storybook/preview-api/dist/chunk-ZVJD52XQ.mjs
...
function getArrayField(moduleExportList, field, options2 = {}) {
  return getField(moduleExportList, field).reduce((a, b2) => options2.reverseFileOrder ? [...b2, ...a] : [...a, ...b2], []);
}
...
var require_entities = __commonJS3({ "../../node_modules/entities/lib/maps/entities.json"(exports, module) {
...
var require_legacy = __commonJS3({ "../../node_modules/entities/lib/maps/legacy.json"(exports, module) {
...
var require_xml = __commonJS3({ "../../node_modules/entities/lib/maps/xml.json"(exports, module) {
  module.exports = { amp: "&", apos: "'", gt: ">", lt: "<", quot: '"' };
} });
var require_decode = __commonJS3({ "../../node_modules/entities/lib/maps/decode.json"(exports, module) {
  module.exports = { "0": 65533, "128": 8364, "130": 8218, "131": 402, "132": 8222, "133": 8230, "134": 8224, "135": 8225, "136": 710, "137": 8240, "138": 352, "139": 8249, "140": 338, "142": 381, "145": 8216, "146": 8217, "147": 8220, "148": 8221, "149": 8226, "150": 8211, "151": 8212, "152": 732, "153": 8482, "154": 353, "155": 8250, "156": 339, "158": 382, "159": 376 };
} });
var require_decode_codepoint = __commonJS3({ "../../node_modules/entities/lib/decode_codepoint.js"(exports) {
...
var require_decode2 = __commonJS3({ "../../node_modules/entities/lib/decode.js"(exports) {
  var __importDefault = exports && exports.__importDefault || function(mod) {
    return mod && mod.__esModule ? mod : { default: mod };
  };
  Object.defineProperty(exports, "__esModule", { value: true });
...
var require_encode = __commonJS3({ "../../node_modules/entities/lib/encode.js"(exports) {
  var __importDefault = exports && exports.__importDefault || function(mod) {
    return mod && mod.__esModule ? mod : { default: mod };
  };
  Object.defineProperty(exports, "__esModule", { value: true });
...
var require_lib2 = __commonJS3({ "../../node_modules/entities/lib/index.js"(exports) {
  Object.defineProperty(exports, "__esModule", { value: true });
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
  ...
  function getDefaultColors() {
    ...
    return range(0, 5).forEach(function(red) {
      ...
      var c2 = gray + 232, l = toHexString(gray * 10 + 8);
      colors[c2] = "#" + l + l + l;
    }), colors;
  }
  function setStyleColor(red, green, blue, colors) {
    var c2 = 16 + red * 36 + green * 6 + blue, r = red > 0 ? red * 40 + 55 : 0, g = green > 0 ? green * 40 + 55 : 0, b2 = blue > 0 ? blue * 40 + 55 : 0;
...
function action(name2, options2 = {}) {
  let actionOptions = { ...config, ...options2 }, handler = function(...args2) {
    let channel = addons.getChannel(), id = v4_default(), minDepth = 5, serializedArgs = args2.map(serializeArg), normalizedArgs = args2.length > 1 ? serializedArgs : serializedArgs[0], actionDisplayToEmit = { id, count: 0, data: { name: name2, args: normalizedArgs }, options: { ...actionOptions, maxDepth: minDepth + (actionOptions.depth || 3), allowFunction: actionOptions.allowFunction || false } };
...
var actions = (...args2) => {
  let options2 = config, names = args2;
  names.length === 1 && Array.isArray(names[0]) && ([names] = names), names.length !== 1 && typeof names[names.length - 1] != "string" && (options2 = { ...config, ...names.pop() });
  let namesObject = names[0];
  (names.length !== 1 || typeof namesObject == "string") && (namesObject = {}, names.forEach((name2) => {
    namesObject[name2] = name2;
  }));
  let actionsObject = {};
  return Object.keys(namesObject).forEach((name2) => {
    actionsObject[name2] = action(namesObject[name2], options2);
  }), actionsObject;
};
export {
  ADDON_ID,
